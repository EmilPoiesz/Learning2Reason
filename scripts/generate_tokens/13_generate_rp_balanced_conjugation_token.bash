...
FOLDER=DATA/TOKEN/NO_CONJUGATION/RP_10X
...
do
   python sample/sample.py --vocab_file sample/token.txt --output_file $FOLDER/prop_examples_$number.txt --min_pred_num 5 --max_pred_num 30 --algo RP_NO_CONJUGATION --example_num 10000 --balance_by_depth --max_depth 6 & 
done
wait
